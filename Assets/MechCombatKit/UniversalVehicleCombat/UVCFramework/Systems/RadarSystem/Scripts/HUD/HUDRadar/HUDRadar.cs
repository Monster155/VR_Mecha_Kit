...
namespace VSX.UniversalVehicleCombat.Radar
{
    ...
    public class HUDRadar : HUDComponent
    {
        ...
        protected virtual void Visualize(Tracker tracker, Trackable trackable)
        {
            ...
            if (display2D)
            {
                radarWidget.transform.localRotation = Quaternion.Euler(0, 0, -Quaternion.FromToRotation(tracker.ReferenceTransform.forward, trackable.transform.forward).eulerAngles.y);
            }
