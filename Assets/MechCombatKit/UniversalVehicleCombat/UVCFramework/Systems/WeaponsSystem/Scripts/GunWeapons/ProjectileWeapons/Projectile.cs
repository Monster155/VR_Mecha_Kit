    ...
    public class Projectile : MonoBehaviour
    {
        ...
        protected virtual void OnCollision(RaycastHit hit)
        {
            ...
            else
            {
                ...
                {
                    // Damage
                    float damageValue = healthModifier.GetDamage(damageReceiver.HealthType) * healthEffectByDistanceCurve.Evaluate(distanceCovered / maxDistance);
                    ...
                    float healingValue = healthModifier.GetHealing(damageReceiver.HealthType) * healthEffectByDistanceCurve.Evaluate(distanceCovered / maxDistance);
