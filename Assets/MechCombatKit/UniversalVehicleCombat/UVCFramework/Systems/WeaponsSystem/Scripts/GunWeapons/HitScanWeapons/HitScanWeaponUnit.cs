    ...
    public class HitScanWeaponUnit : WeaponUnit, IRootTransformUser
    {
        ...
        public virtual void RaycastHitDamage(RaycastHit hit)
        {
            ...
            if (damageReceiver != null)
            {
                ...
                float damageValue = effectOverRange.Evaluate((hit.point - spawnPoint.position).magnitude / range) * 
                ...
                float healingValue = effectOverRange.Evaluate((hit.point - spawnPoint.position).magnitude / range) * 
