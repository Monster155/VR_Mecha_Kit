...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class RigidbodyCharacterController : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            {
                RaycastHit hit;
                if (Physics.Raycast(transform.position, -Vector3.up, out hit, startGroundedCheckDistance, groundMask, QueryTriggerInteraction.Ignore))
                {
        ...
        protected virtual void Reset()
        {
            ...
            if (renderers.Length > 0)
            {
                ...
                GetComponent<CapsuleCollider>().center = new Vector3(0f, Mathf.Max(bounds.extents.y, radius), 0);
            }
        }
